...
const cacheName = 'Assignment3DavisSunderland-2021-03-14 14:38:53.101178'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Assignment3DavisSunderland'.length) === 'Assignment3DavisSunderland') {
